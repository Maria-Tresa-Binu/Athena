...
export interface ProviderContext {
    ...
    userId: string;
    connectedAccountIds?: string[];
    execute: (toolId: string, arguments_: unknown, connectedAccountId?: string) => Promise<unknown>;
}
export interface ToolkitProvider<Output = unknown> {
    createTools(context: ProviderContext): Output;
}
export type ProviderOutput<Provider> = Provider extends ToolkitProvider<infer Output> ? Output : ToolDescriptor[];
export type RouterProviderOutput<Provider> = Provider extends ToolkitProvider<infer Output> ? Output : ToolDescriptor[];
